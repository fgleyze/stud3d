    ...
    render() {
        return (<div> 
            ...
            {this.state.isOpen && <div className="m-2 p-4 text-justify bg-orange-200 text-sm rounded-lg">
                <p>Cet outil permet de générer des murs de maison à <a href="https://fr.wikipedia.org/wiki/Ossature_plate-forme" target="_blank">ossature plate-forme</a> et de récupérer la liste de toutes les longueurs de sections bois nécessaires 👷</p>
            </div>} 
        </div>)
    }
}
